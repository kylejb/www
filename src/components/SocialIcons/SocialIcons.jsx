...
const SocialIcon = () => {
    ...
    return (
        <StyledContainer>
            <StyledAnchorTag id="github-icon" target="_blank" rel="noopener noreferrer" href="https://github.com/kylejb" themeColor={colorPrimary}><i className="fab fa-github"></i></StyledAnchorTag>
            <StyledAnchorTag id="twitter-icon" target="_blank" rel="noopener noreferrer" href="https://twitter.com/kyleburda" themeColor={colorPrimary}><i className="fab fa-twitter"></i></StyledAnchorTag>
            <StyledAnchorTag id="stackoverflow-icon" target="_blank" rel="noopener noreferrer" href="https://stackoverflow.com/story/kylejb" themeColor={colorPrimary}><i className="fab fa-stack-overflow"></i></StyledAnchorTag>
            <StyledAnchorTag id="linkedin-icon" target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/kyleburda" themeColor={colorPrimary}><i className="fab fa-linkedin"></i></StyledAnchorTag>
            <StyledAnchorTag id="devto-icon" target="_blank" rel="noopener noreferrer" href="https://dev.to/kylejb">
                <svg viewBox="0 0 408 410">
                    ...
                    <path style={{ fill: colorPrimary }} d="M80 205v51.2l10.3-.4c8.9-.3 10.8-.7 14.8-3 7.8-4.6 7.9-4.9 7.9-48.4 0-42.4 0-42.4-7.3-47.2-3.6-2.4-5.1-2.7-14.9-3.1l-10.8-.3V205z" />
                </svg>
            </StyledAnchorTag>
        </StyledContainer>
    );
