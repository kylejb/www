      ...
      <main style={{ color: colorPrimary }}>
        <div className="about-wrapper">
          ...
          <div className="about-content">
            <p>
              I am driven by a deep desire to utilize technology to make a
              positive impact.
            </p>

            <h4>Skills</h4>
            <h6>Languages</h6>
            <p>Python, Ruby, JavaScript, TypeScript, SQL, HTML, CSS</p>

            <h6>Libraries and Frameworks</h6>
            <p>
              React, Redux, Node, Express, Ruby on Rails, FastAPI, Django,
              Flask, Jest, Selenium
            </p>
